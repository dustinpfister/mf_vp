/*
   ...
   This is a hack over of mf_canvas_0_0_15.
   
   what has changed
   
   * made it so C.dBX draws a box relative to the upper left point rather than the center
   that is stbx.x and stbx.y should be the upper left point of the box
   * added a feature in C.dBX that allows the switching back by way of a bool
   
   C.dBX(stbx,false,true); // render 'center relative'
